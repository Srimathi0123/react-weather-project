  ...
  <React.Fragment>
    <div class="container">
      <div className='headingwe'>
        <h2>Here,YOU CAN SEE YOUR WEATHER</h2>
      </div>
      <input
        className='inputcolr'
        type='text'
      ...
      />
       ...
       <div>  <button className='butcolor' onClick={getWeatherHandle}>Find</button></div>
       
            {current && <div className='card'>
        <div className='container-card'>
        <img src={`https:${condition.icon}`} />
        <div className='cloud'>{condition.text}</div>
          <div className='place-name'>{weatherLocation.name}  {current.temp_c}&deg;C</div>
